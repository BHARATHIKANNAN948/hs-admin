...
import Casestudy_List from "../../components/Lists/casestudyList";
import Mobile_Banner_List from "../../components/Lists/mobile-banner";
import Desktop_Banner_List from "../../components/Lists/desktop-banner";
              ...
              <div class="container-xxl flex-grow-1 container-p-y text-start">
                ...
                <div class="card pb-4">
                  <div className="d-flex justify-content-between">
                    <div>
                      <h5 class="card-header">Desktop Screen List</h5>
                    </div>
                    <div className="p-3">
                      <Link to={"/banner-desktop-form"}>
