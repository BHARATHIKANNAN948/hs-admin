...
import ChooseUs_List from "../../components/Lists/chooseusList";
            ...
            <div class="content-wrapper">
              <div class="container-xxl flex-grow-1 container-p-y text-start">
                <h4 class="fw-bold py-3 mb-4">
                  <Link to={'/dashboard'}> <span class="text-muted fw-light">Dashboard /</span></Link> Choose Us
                </h4>
                <div class="card pb-4">
                  <div className="d-flex justify-content-between">
                    <div>
                      <h5 class="card-header">ChooseUs List</h5>
                    </div>
                    <div className="p-3">
                      <Link to={"/chooseus-form"}>
