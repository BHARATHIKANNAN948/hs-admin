...
function CasestudyCategory() {
  ...
  const Portfoliolist = async (page) => {
    ...
    try {
      ...
      if (responseData.apiStatus.code === "200") {
        setPortfolioList(responseData.responseData);
        setGetId(responseData.responseData.id);
  ...
  const handledelete = async () => {
    try {
      const response = await LoginAPI.caseStudyPlatformSubDeleteAPI(id);
  ...
  const GetApiUpdate = async (id) => {
    try {
      ...
      const FullImagePath = `${baseURL}${data.image_path}`;
              ...
              {list?.length > 0 ? (
                list.map((value, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <strong>{value.technology_name}</strong>
                    </td>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <Link
                            to={`/casestudy-category-form/${value.id}`}
                            class="dropdown-item"
                          >
